...
<div style="text-align: center;">
  ...
  <div style="padding-bottom: 20px;">
    AP Computer Science Training: <a href="https://runestone.academy/ns/books/published/HartHS_APCSA_FRC24/index.html" target="_blank">Oceana_Robotics_APCSA</a><br>
  </div>
  <div style="padding-bottom: 20px;">
    The Blue Alliance: <a href="https://www.thebluealliance.com/team/6128" target="_blank">Team 6128 Stats</a><br>
  </div>
  <div style="padding-bottom: 20px;">
    Robotics Poster: <a href="https://drive.google.com/file/d/1ncob92Pq0ILPDAlG7XROPMt_NxwRxsf3/view?usp=sharing" target="_blank">Download Poster</a><br>
  </div>
  <div style="padding-bottom: 20px;">
...
<p style="color: orange; font-family: Arial, sans-serif; font-size: 19px; margin: 0; font-weight: bold;">
  We can teach you how to:</p>
  <ul style="list-style-type: disc; text-align: left;">
    <li style="color:red; font-size: 18px;"><span style="color:black;">build a personal website</span></li>
    <li style="color:gray; font-size: 18px;"><span style="color:black;">make online resumé</span></li>
    <li style="color:blue; font-size: 18px;"><span style="color:black;">use electronic sensors</span></li>
    <li style="color:orange; font-size: 18px;"><span style="color:black;">try digital advertising</span></li>
    <li style="color:green; font-size: 18px;"><span style="color:black;">create a scholarship page</span></li>
    <li style="color:purple; font-size: 18px;"><span style="color:black;">launch 'sponsor-me' page</span></li>
    <li style="color:green; font-size: 18px;"><span style="color:black;">build 3D CAD models</span></li>
    <li style="color:blue; font-size: 18px;"><span style="color:black;">program/code w/ JAVA</span></li>
    <li style="color:gray; font-size: 18px;"><span style="color:black;">use a 3D printer</span></li>
    <li style="color:red; font-size: 18px;"><span style="color:black;">fabricate and use tools</span></li>
  </ul><br>
