...
<p style="color: orange; font-family: Arial, sans-serif; font-size: 30px; margin: 0; font-weight: bold;">
  ...
  <ul style="list-style-type: disc; text-align: left;">
    ...
    <li style="color:orange; font-size: 20px;"><span style="color:black;">try digital advertising</span></li>
    ...
    <li style="color:blue; font-size: 20px;"><span style="color:black;">program / code using JAVA</span></li>
    <li style="color:gray; font-size: 20px;"><span style="color:black;">use a 3D printer</span></li>
