...
<p style="color: orange; font-family: Arial, sans-serif; font-size: 20px; margin: 0; font-weight: bold;">
  ...
  <ul style="list-style-type: disc; text-align: left;">
    <li style="color:red; font-size: 19px;"><span style="color:black;">build a personal website</span></li>
    <li style="color:gray; font-size: 19px;"><span style="color:black;">make an online resumé</span></li>
    <li style="color:blue; font-size: 19px;"><span style="color:black;">use electronic sensors</span></li>
    <li style="color:orange; font-size: 19px;"><span style="color:black;">try digital advertising</span></li>
    <li style="color:green; font-size: 19px;"><span style="color:black;">create a scholarship page</span></li>
    <li style="color:purple; font-size: 19px;"><span style="color:black;">launch a 'sponsor-me' page</span></li>
    <li style="color:green; font-size: 19px;"><span style="color:black;">build 3D CAD models</span></li>
    <li style="color:blue; font-size: 19px;"><span style="color:black;">program/code w/ JAVA</span></li>
    <li style="color:gray; font-size: 19px;"><span style="color:black;">use a 3D printer</span></li>
    <li style="color:red; font-size: 19px;"><span style="color:black;">fabricate and use tools</span></li>
  </ul><br>
